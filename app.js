...
const cartegoryRouter = require('./routes/cartegoryRoutes');
...
app.use('/api/v1/cartegories', cartegoryRouter);
...
app.get('/', (req, res) => {
  res.status(200).json({
    status: 'ok',
    message: '  scaleable ecommerce website  API is running',
  });
});
